...
export const ENVIRONMENTS = {
    ...
    PROD: {
        ...
        authorizationEndpoint: 'https://id.gov.et/authorize',
        tokenEndpoint: 'https://id.gov.et/v1/esignet/oauth/v2/token',
        userInfoEndpoint: 'https://id.gov.et/v1/esignet/oidc/userinfo',
